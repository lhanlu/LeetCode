 ...
 * to version three", it is the fifth second-level revision of 
 * the second first-level revision.
 * You may assume the default revision number for each level of 
 * a version number to be 0. For example, version number 3.4 has 
 * a revision number of 3 and 4 for its first and second level revision number. 
